        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="add-${type}-modal-form" action="${actionUrl}" method="post">
              <input type="text" class="form-control" id="${type}-id-field" name="topicObjId" value="" hidden>
              <input type="text" class="form-control" id="name-field" name="name" value="" required>
